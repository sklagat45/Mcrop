            ...
            public void onClick(View v) {
                if (packageManager
                    ...
                    try {
                        ...
                        SharedPreferenceManager.saveTemporaryImagePath(AddFruitStockActivity.this, imageFile.getAbsolutePath());
                        invokeCamera(imageFile);
                    } catch (IOException e) {
                        Toast.makeText(AddFruitStockActivity.this, "An error occurred",
                ...
                if (onLoadFinishedCalled == false) {
                    ...
                    try {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                            ...
                            Cursor cursor = AddFruitStockActivity.this.getContentResolver()
